...
<body>
    <form action="updatee.php" method="get">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="<?php echo $res['eid']; ?>" id="formGroupExampleInput" placeholder="ID" name="id">
        </div>
        <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">请更改姓名</label>
            <input type="text" class="form-control" value="<?php echo $res['ename']; ?>" id="formGroupExampleInput2" placeholder="NAME" name="cname">
        </div>
        <div class="mb-3">
